  ...
  function keyPress() {
    ...
    function status(btn) {
        if(btn.checked==true) {
            ...
            document.getElementsByClassName("full")[2].insertAdjacentHTML("afterBegin", "<input class='target' type='number' placeholder='Tertiary target (in sec)'></input>");
            document.getElementsByClassName("full")[2].insertAdjacentHTML("afterBegin", "<input class='target' type='number' placeholder='Secondary target (in sec)'></input>");
            document.getElementsByClassName("full")[2].insertAdjacentHTML("afterBegin", "<input class='target' type='number' placeholder='Primary target (in sec)'></input>");
        }
        else {
          thirdSlide();
          challenge=false;
